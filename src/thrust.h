...
extern uint32_t lenx; /* Banans max i x-len, anv�nds senare till den aktuella */
extern uint32_t leny; /* Banans max i y-len, storleken p� banan.S�tts i readbana */
...
int insideblock(int blockx, int blocky, int pblockx, int pblocky, int sx, int sy);
int insidepixel(int x, int y, int pixx, int pixy, int sx, int sy);
void updateborder(int pblockx, int pblocky, int bblockx, int bblocky, int vx, int vy);
void fade_in(void);
void fade_out(void);
